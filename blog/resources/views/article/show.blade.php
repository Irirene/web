...
<div class="card">
  <div class="card-body">
    ...
    <div class="d-flex">
    <a class="btn btn-info mr-1" href="/article/{{$article->id}}/edit" class="card-link">Edit Comment</a>
    <a class="btn btn-danger mr-1" href="/article/{{$article->id}}" class="card-link">Delete Comment</a>
    </div>
  </div>
</div>
</div>
